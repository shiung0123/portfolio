...
class myCNN:
    ...
    def build_model(self):
        ...
        # rau_1 (120, 60, 32)/(120, 60, 15*32+32)
        # self.rau_1 = self.RAU(self.pool_2, 15, 32) 

        # conv_3 (120, 60, 32)/(60, 30, 64)
        self.w_conv3 = self.weight_variable([5, 5, 32, 64])
        self.b_conv3 = self.bias_variable([64])
        self.y_conv3 = self.conv2d(self.pool_2, self.w_conv3) + self.b_conv3
        self.relu_3 = tf.nn.relu(self.y_conv3)
        self.pool_3 = self.max_pool_2x2(self.relu_3)

        # rau_2 (120, 60, 256)/(120, 60, 15*128+128)
        # self.rau_2 = self.RAU(self.pool_3, 15, 128) 

        # conv_4 (60, 30, 64)/(30, 15, 128)
        self.w_conv4 = self.weight_variable([5, 5, 64, 128])
        self.b_conv4 = self.bias_variable([128])
        self.y_conv4 = self.conv2d(self.pool_3, self.w_conv4) + self.b_conv4
