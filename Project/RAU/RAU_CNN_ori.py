...
class myCNN:
    ...
    def build_model(self):
        ...
        # conv_3 (120, 60, 512)/(60, 30, 128)
        self.w_conv3 = self.weight_variable([5, 5, 512, 128])
        ...
        # conv_4 (60, 30, 2048)/(30, 15, 512)
        self.w_conv4 = self.weight_variable([5, 5, 2048, 512])
        ...
        self.w_fc1 = self.weight_variable([30*15*512, 64])
